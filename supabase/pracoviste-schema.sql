...
--
-- Pozn.: Skript lze spouštět opakovaně. RLS je před INSERTem, aby nevznikla chyba
...
-- RLS před jakýmkoli INSERT/UPDATE (jinak při opakovaném spuštění padá ALTER TABLE)
...
-- Kořen stromu — DO NOTHING, aby opakované spuštění nespouštělo UPDATE trigger
